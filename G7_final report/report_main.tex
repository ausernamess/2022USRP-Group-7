...
The probability of $\omega$ happening in Boltzmann distribution can be describe as 
$$
    \mathbb{P}_\beta(\omega) = \frac{1}{\mathbb{Z_\beta}}e^{-\beta H(\omega)}, \quad \text{where $\mathbb{Z}_\beta = \sum_{\omega \in \Omega} e^{-\beta H(\omega)}$ is a normalization constant}
$$ 
